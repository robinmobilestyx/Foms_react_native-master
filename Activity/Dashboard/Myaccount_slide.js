...
//             officer_number:officerno,platoon:platoon,
//             platoon:platoon,
//             level:level,
//         })
//     }
...
{/* Second  Main Flex */}
            ...
            <View style={styles.singleItemsView}>
             ...
             <View style={styles.singleItemsView}>
             <Image style={styles.profileimage}
                       source={cloudImage}></Image>
                       <Text style={styles.officer_name}>{level}</Text>
             </View>
             <View style={styles.singleItemsView}>
             <Image style={styles.profileimage}
                       source={verify_user}></Image>
                       <Text style={styles.officer_name}>Officer Number {officer_number}</Text>
             </View>
             <View style={styles.singleItemsView}>
             <Image style={styles.profileimage}
                       source={watch_later}></Image>
           ...
           {/* Second  sub Flex */}
            ...
            <Image style={styles.largeprofileimage}
                       source={profileImage}></Image>
            </View>
             </View>
            </SafeAreaView>
