...
import { Image,View,TouchableOpacity,Text,Alert,Linking } from 'react-native';
    ...
    getHelpData = async()=>{
        try{
          ...
          if(uname != null){
           ...
           const abc =await new FooterController().helpData(paramsBody,navigation,"help",Global_Attributes.faq_data);
           abc;
           setIsLoading(false);
          }
          else{
       ...
       <View style={DashboardFooterStyle.container} >
           ...
           {/*CheckIn Container*/}
            ...
            <Image
                ...
                <Text style={DashboardFooterStyle.text}>Speeding Chart         </Text>
                </TouchableOpacity>
            </View> */}

            {/* Initiate Offence Container */}
            {/* <View style={DashboardFooterStyle.me}>
            ...
            <Image
                ...
                <Text style={DashboardFooterStyle.text}>   Initiate Offence</Text>
            ...
            <View style={DashboardFooterStyle.support}>
                <TouchableOpacity activeOpacity = { 0.9 } onPress={()=>{
                    ...
                    Alert.alert(
                        'Information',' To contact support,email us at\n\n support@mobilestyx.co.in',
                        [
                          {
                            text: 'Go To Mail',
                            onPress: () => Linking.openURL(
                          'mailto:support@mobilestyx.co.in',
                          ),
                          },
