...
import { SafeAreaView, StyleSheet, View,Image,Text, TextInput, 
...
export default class Enter_Otp extends Component{
  ...
  apiCall=async()=>{
   ...
   const abc = await new NumVerificationController().handleClick(numberVerBody,this.props,"Enter_Otp",Global_Attributes.enterOtp); 
   abc;
