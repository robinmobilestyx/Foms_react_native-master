...
import { Platform, StyleSheet, View,Image,SafeAreaView,Text,ActivityIndicator,platform,Alert,BackHandler,LogBox} from 'react-native';
...
requestPermission = async(permission)=>{
    try{
      ...
      api_call=async()=>{
        ...
        const abc = await new NumVerificationController().handleClick(splashBody,this.props,"splash",Global_Attributes.splashUrl);
        abc;
            ...
            return(  
              ...
              <View style={styles.SplashScreen_RootView}>  
               <View style={styles.SplashScreen_ChildView}> 
                     ...
                     <Image source={this.App_icon}  
                     style={{width:'70%', height: '70%', resizeMode: 'contain'}}
                   />  
                   <Loader loading={Global_Attributes.loading} />
              </View> 
              <View style ={{ alignSelf: 'flex-end' , right:0, margin:5,
               bottom:0, position:'absolute'}} >
              <Text style ={{fontSize: 14, margin: 5,fontWeight:"bold",
                  alignSelf: 'center'}}>Version {packageJson.version}</Text>
               </View>
          </View>
