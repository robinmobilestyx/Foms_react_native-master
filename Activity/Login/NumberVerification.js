...
import { StyleSheet, Text, SafeAreaView,Image,View, TextInput, 
TouchableOpacity,Div,ActivityIndicator,Alert,Plateform,Linking} from 'react-native';
    ...
    [
      {
        text: "OK",
        textColor:'#11246F',
        onPress: () => {this.checkPermission(PERMISSION_TYPE.phone_state)},
      },
    ],
...
api_call=async()=>{
   ...
   //console.log("Phone num on controller :"+no);
    ...
    const abc = await new  NumVerificationController().handleClick(numberVerBody, this.props, "NumberVerification", Global_Attributes.numberVerify);
    abc;
    ...
    render()
    {
        return(
            ...
            <View style={NumberVerificationStyle.bgView}>
                    <Image style={NumberVerificationStyle.bg_image}
                    source={bg_Image}></Image>
            </View>

            <View style={NumberVerificationStyle.logoView}>
                <Image style={NumberVerificationStyle.logo} 
            ...
            <Text style={NumberVerificationStyle.text}>Enter {"\n"}Phone Number</Text>
            </View>

            <View style={NumberVerificationStyle.inputView}>
            <TextInput style={NumberVerificationStyle.inputText} maxLength={10} 
            ...
            {this.props.route.params.isVisible ? <View>
            <Text style={NumberVerificationStyle.ORText}>OR</Text>
            <TouchableOpacity style={NumberVerificationStyle.goToLoginView}
                  onPress={() =>{ 
                    this.props.navigation.navigate('LoginPage');
                    }}>
                <Text style={NumberVerificationStyle.goToLoginText}>Go To Login Page</Text>
            </TouchableOpacity>
            </View>
            : null
            }
            ...
            <Text style={NumberVerificationStyle.supportText}>To contact support, email us at </Text>
            <TouchableOpacity
