 ...
 this.setState({isChacked : !this.state.isChacked})
    ...
    next=async()=>{
        ...
        let deviceId = DeviceInfo.getUniqueId();
            ...
            const abc = await new NumVerificationController().handleClick(numberVerBody,this.props,"Create_Pin",Global_Attributes.CreatePinAndLogin);
            abc; 
        ...
        return(
            ...
            {Global_Attributes.pinSuccess ? (
              <Checkbox
                ...
                animationType={'left'}
                size={18}
                labelStyle={{paddingBottom:5,color:'black'}}
