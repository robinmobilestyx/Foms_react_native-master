...
import { SafeAreaView, StyleSheet, View,Image,Text, TextInput, TouchableOpacity,BackHandler} from 'react-native';
...
//  this.unsubscribe();
  // BackHandler.removeEventListener("hardwareBackPress", this.backAction);   
    ...
    const abc= await new NumVerificationController().handleClick(numberVerBody,this.props,"Login",Global_Attributes.enterPin); 
    ...
    //     const fp =  await AsyncStorage.getItem("fpenroll");
    //     console.log("Session Values on login:"+fp);
    //     if(fp ==  "Yes")
    //     {
    ...
    render(){
        ...
        <Text style={LoginStyle.text}>Enter Pin <Image style={LoginStyle.enterPinImage} source={lock_image}/></Text>
        <TextInput 
        ...
        <TouchableOpacity   
        onPress={() => { this.next('pin');}}>
        <Text style={LoginStyle.buttontext}>LOGIN</Text>
        </TouchableOpacity>
        </View>
        </View>
        {this.state.loginSession == 'Yes'?<View>
        <Image style={LoginStyle.fingerprintimage} source={fingerprint}/> 
        <Text style={LoginStyle.fingertext}>Login Using Fingerprint Place your finger on fingerprint{"\n"}scanner to login</Text>
        </View>:null}
