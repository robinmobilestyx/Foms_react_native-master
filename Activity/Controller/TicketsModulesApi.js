...
class TicketsModulesApi extends Component {
    ...
    ticketIdNo = async(responseJson, link, uname, props) => {
        ...
        props.navigation.replace('Print', { url: link, module: "PonInfo", uname: uname });
                ...
                if (responseJson.status == "200" || responseJson.status == "success") {
                    ...
                    switch (previouScreen) {
                        ...
                        case "PonInfo":
                            ...
                            this.ticketIdNo(responseJson, responseJson.pdf_link, uname, props);
                            // api response
                            break;
                        case "warning":
                            console.log(" pdf link:" + responseJson.pdf_link);
                            const name = bodyParameters["uname"]
                            props.navigation.replace('Print', { url: responseJson.pdf_link, module: "warning", uname: name });
                            // api response
                            break;
                        case 'prevLocation':
                            ...
                            Global_Attributes.gpsAddress['gpsPincode'] = responseJson.data.pincode;
