                    ...
                    switch (previouScreen) {
                        case 'PonReports':
                            ...
                            for (let i = 0; i < ticketValue; i++) {
                                ...
                                TicketData['fname' + i + 'lname' + i + 'mname' + i] = responseJson.data[i].fname + " " + responseJson.data[i].lname + " " + responseJson.data[i].mname;
                                TicketData['form_date' + i] = responseJson.data[i].form_date;
                                TicketData['offender_copy' + i] = responseJson.data[i].pdfs['pon'];
                                TicketData['OfficerPonPdf' + i] = responseJson.data[i].pdfs['pon_officer'];
                                TicketData['CourtPonPdf' + i] = responseJson.data[i].pdfs['pon_court'];
                                TicketData['hold_status' + i] = responseJson.data[i].hold_status;
                            ...
                            props.navigation.navigate('PonReports', { TicketData: TicketData, Length: ticketValue });
                            break;
                        ...
                        case 'PonWarning':
                            ...
                            for (let i = 0; i < ticketValue1; i++) {
                                TicketData['fname' + i + 'lname' + i + 'mname' + i] = responseJson.data[i].fname + " " + responseJson.data[i].lname + " " + responseJson.data[i].mname;
                                TicketData['form_date' + i] = responseJson.data[i].form_date;
                                TicketData['offender_copy' + i] = responseJson.data[i].pdfs['warning'];

                                // console.log("Name=" + TicketData['fname' + i + 'lname' + i + 'mname' + i]);
                                // console.log("Form Date=" + TicketData['form_date' + i]);
                                // console.log("Offender copy=" + TicketData['offender_copy' + i]);
                            }
                            props.navigation.navigate('PonWarning', { TicketData: TicketData, Length: ticketValue1 });
                            break;
                        ...
                        case 'PonReleaseForm':
                            ...
                            for (let i = 0; i < ticketValue2; i++) {
                                ...
                                TicketData['offender_name' + i] = responseJson.data[i].offender_name;
                                TicketData['offence_date' + i] = responseJson.data[i].offence_date;
                                TicketData['appearance_notice' + i] = responseJson.data[i].pdfs['appearance_notice'];
                                TicketData['affidivat_notice' + i] = responseJson.data[i].pdfs['affidivat_notice'];
                            ...
                            props.navigation.navigate('PonReleaseForm', { TicketData: TicketData, Length: ticketValue2 });
                            break;
                        ...
                        case 'PonSummons':
                            ...
                            for (let i = 0; i < ticketValue3; i++) {
                                ...
                                TicketData['form_date' + i] = responseJson.data[i].form_date;
                                TicketData['fname' + i + 'lname' + i + 'mname' + i] = responseJson.data[i].fname + " " + responseJson.data[i].lname + " " + responseJson.data[i].mname;
                                TicketData['summon3_drivers' + i] = responseJson.data[i].pdfs['summon3_drivers'];
                                TicketData['summon3_officer' + i] = responseJson.data[i].pdfs['summon3_officer'];
                                TicketData['summon3_affidivat' + i] = responseJson.data[i].pdfs['summon3_affidivat'];
                                TicketData['hold_status' + i] = responseJson.data[i].hold_status;

                            }
                            props.navigation.navigate('PonSummons', { TicketData: TicketData, Length: ticketValue3 });
                            break;
                        default:
