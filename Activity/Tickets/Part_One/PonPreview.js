...
import { SafeAreaView, StyleSheet, View, Image, Text, Picker } from 'react-native';
...
export default class PonPreview extends Component {
    ...
    generatePon = async (url, type) => {
        ...
        var splashBody = {
            ...
            vehicle_involvement: Global_Attributes.PonOneBean['motorInvolved'] ? 'Y' : 'N',
                ...
                <ScrollView style={previewStyle.Scrollview}>
                    ...
                    <View style={previewStyle.locationView}>
                        ...
                        <View style={previewStyle.loc_code_view}>
                            ...
                            <Text style={previewStyle.loc_code_no}>{Global_Attributes.PonOneBean['locationCode']}</Text>
                        </View>
                        ...
                        <View style={previewStyle.offn_view}>
                            ...
                            <Text style={previewStyle.loc_code_no}>{Global_Attributes.PonOneBean['formatted']}</Text>
                        </View>

                    </View>

                    <View style={previewStyle.offr_name_view}>
                        <Text style={previewStyle.offr_name}>Officer Name : {Global_Attributes.PonOneBean['officerName']}</Text>
                    </View><View style={{ flex: 1, height: 60 }}>
                        ...
                        <Text style={{ color: '#11246F', bottom: "80%", start: '23%', fontSize: 12 }}>Info</Text>
                        <Text style={{ color: '#11246F', bottom: "105%", alignSelf: 'center', fontSize: 12 }}>Offence</Text>
                        <Text style={{ color: '#11246F', bottom: "130%", start: '68%', fontSize: 12 }}>Review</Text>
                    </View>

                    <View style={previewStyle.inputTextStyleView}>
                        <View style={previewStyle.main_text_views}>
                            <TextInput style={previewStyle.inputTextStyleTwo}
                                value={Global_Attributes.PonOneBean['date']}
                                editable={false}
                                label='DATE' underlineColor={'#7B7B7B'}></TextInput>
                        </View>
                        <View style={previewStyle.main_text_views1}>
                            <TextInput style={previewStyle.inputTextStyleTwo}
                                value={Global_Attributes.PonOneBean['time']}
                                editable={false}
                                label='TIME' underlineColor={'#7B7B7B'} ></TextInput>
                        </View>
                    </View>

                    <View style={previewStyle.inputTextStyleView}>
                        <View style={previewStyle.inputTextStyleView1}>
                            <TextInput style={previewStyle.inputTextStyleThree}
                                editable={false}
                                value={Global_Attributes.PonOneBean['family']}
                                label='FAMILY*' underlineColor={'#7B7B7B'}></TextInput>
                        </View>
                        <View style={previewStyle.inputTextStyleView2}>
                            <TextInput style={previewStyle.inputTextStyleThree}
                                editable={false}
                                label='GIVEN' underlineColor={'#7B7B7B'}
                                value={Global_Attributes.PonOneBean['given']}  ></TextInput>
                        </View>
                        <View style={previewStyle.inputTextStyleView3}>
                            <TextInput style={previewStyle.inputTextStyleThree}
                                editable={false}
                                label='INITIALS' underlineColor={'#7B7B7B'}
                    ...
                    <View style={previewStyle.inputTextStyleView}>
                        <View style={previewStyle.main_text_views}>
                            <TextInput style={previewStyle.inputTextStyleTwo}
                                ...
                                label='NUMBER AND STREET' underlineColor={'#7B7B7B'}>
                            </TextInput>
                        </View>
                        <View style={previewStyle.main_text_views1}>
                            <TextInput style={previewStyle.inputTextStyleTwo}
                                editable={false}
                                label='MUNCIPALITY' underlineColor={'#7B7B7B'}
                                value={Global_Attributes.PonOneBean['muncipality']}  >
                            </TextInput>
                        </View>
                    </View>
                    ...
                    <View style={previewStyle.inputTextStyleView}>
                        <View style={previewStyle.inputTextStyleView1}>
                            <TextInput style={previewStyle.inputTextStyleThree}
                                ...
                                label='PO' underlineColor={'#7B7B7B'}></TextInput>
                        </View>
                        <View style={previewStyle.inputTextStyleView2}>
                            <TextInput style={previewStyle.inputTextStyleThree}
                                editable={false}
                                value={Global_Attributes.PonOneBean['province']}
                                label='PROVINCE' underlineColor={'#7B7B7B'} ></TextInput>
                        </View>
                        <View style={previewStyle.inputTextStyleView3}>
                            <TextInput style={previewStyle.inputTextStyleThree}
                                editable={false}
                                value={Global_Attributes.PonOneBean['postl']}
                                label='POSTAL CODE' underlineColor={'#7B7B7B'} ></TextInput>
                        </View>
                    </View>
                    ...
                    <View style={previewStyle.inputTextStyleView}>
                        <View style={previewStyle.main_text_views}>
                            <TextInput style={previewStyle.inputTextStyleTwo}
                                ...
                                label='DRIVERS LICENSE NUMBER' underlineColor={'#7B7B7B'}></TextInput>
                        </View>
                        <View style={previewStyle.main_text_views1}>
                            <TextInput style={previewStyle.inputTextStyleTwo}
                                editable={false}
                                value={Global_Attributes.PonOneBean['juris']}
                                label='JURIS' underlineColor={'#7B7B7B'}></TextInput>
                        </View>
                    </View>
                    <View style={previewStyle.inputTextStyleView}>
                        <View style={previewStyle.main_text_views}>
                            <TextInput style={previewStyle.inputTextStyleTwo}
                                ...
                                label='DATE OF BIRTH' underlineColor={'#7B7B7B'}></TextInput>
                        </View>

                        <View style={previewStyle.main_text_views1}>
                            <View style={previewStyle.sexStyle}>
                                <Text style={{ fontSize: 12, color: '#7B7B7B' }}>SEX*</Text>
                                <Text style={{ fontSize: 18, color: '#7B7B7B' }}>{Global_Attributes.PonOneBean['gender']}</Text>
                            </View>
                        </View>
                    </View>
                    <View style={previewStyle.mv_view}>
                            ...
                            <View style={previewStyle.firstCheckbx}>
                                <View pointerEvents="none" style={{ flex: 1 }}>
                                    <CheckBox
                                        ...
                                        rippleEffect={false}
                                        label="NO"
                                        labelStyle={{ color: '#7B7B7B', marginLeft: "-10%" }}>
                                    </CheckBox>
                                </View>
                        ...
                        <View style={previewStyle.cols_view}>
                            ...
                            <View style={previewStyle.secCheckbx}>
                                <View pointerEvents="none" style={{ flex: 1 }}>
                                    <CheckBox checked={Global_Attributes.PonOneBean['collision']}
                                        ...
                                        rippleEffect={false}
                                        label="YES"
                                        labelStyle={{ color: '#7B7B7B', marginLeft: "-10%" }}></CheckBox>
                                </View>
                                {/* <Text style={{ paddingTop: "8%", color: '#7B7B7B' }}>No</Text> */}
                            </View>
                        </View>
                        <View style={previewStyle.cols_view}>
                            ...
                            <View style={previewStyle.thirdCheckbx}>
                                <View pointerEvents="none" style={{ flex: 1 }}>
                                    <CheckBox checked={Global_Attributes.PonOneBean['withnesses']}
                                        // style={{ marginStart: 30, marginTop: 10 }}
                                        unCheckedBorderColor={'#7B7B7B'}
                                        checkedBackgroundColor={"#7B7B7B"}
                                        checkedBorderColor={"#7B7B7B"}
                    ...
                    <View style={previewStyle.inputTextcodeView}>
                        <TextInput style={previewStyle.inputTextStyle}
                            editable={false}
                            label='CONTRARY TO' underlineColor={'#7B7B7B'}
                            value={Global_Attributes.PonOneBean['contrary']}
                        ></TextInput>
                    </View>
                    <View style={previewStyle.inputTextcodeView}>
                        <TextInput style={previewStyle.inputTextStyle}
                            editable={false}
                            label='DID COMMIT' underlineColor={'#7B7B7B'} value={Global_Attributes.PonOneBean['didCommit']}></TextInput>
                    </View>
                    ...
                    <View style={previewStyle.inputTextcodeView}>
                        <TextInput style={previewStyle.inputTextStyle}
                            editable={false}
                            label='SECT' underlineColor={'#7B7B7B'} value={Global_Attributes.PonOneBean['sect']}></TextInput>
                    </View>
                    ...
                    <View style={previewStyle.inputTextStyleView}>
                        <View style={previewStyle.main_text_views}>
                            <TextInput style={previewStyle.inputTextStyleTwo}
                                editable={false}
                                label='PLATE NUMBER' underlineColor={'#7B7B7B'} value={Global_Attributes.PonOneBean['plateNumber']}></TextInput>
                        </View>
                        <View style={previewStyle.main_text_views1}>
                            <TextInput style={previewStyle.inputTextStyleTwo}
                                editable={false}
                                label='JURIS' underlineColor={'#7B7B7B'} value={Global_Attributes.PonOneBean['juris']} ></TextInput>
                        </View>
                    </View>
                    ...
                    <View style={previewStyle.inputTextcodeView}>
                        <TextInput style={previewStyle.inputTextStyle}
                            editable={false}
                            label='CODE' underlineColor={'#7B7B7B'} value={Global_Attributes.PonOneBean['code']}></TextInput>
                    </View>

                    <View style={previewStyle.secCheckboxView}>
                        <View style={{ flexDirection: 'column', flex: 1.2, paddingLeft: "4%", marginTop: "5%", }}>
                            <Text style={previewStyle.cvorText}>CVOR</Text>
                            {/* <View style={{ marginStart: "25%", flexDirection: 'row' }}> */}
                            <View pointerEvents="none" >
                                <CheckBox checked={Global_Attributes.PonOneBean['cvor']}
                                    // style={{ marginStart: 30, marginTop: 20 }}
                                    unCheckedBorderColor={'#7B7B7B'}
                                    checkedBackgroundColor={"#7B7B7B"}
                                    checkedBorderColor={"#7B7B7B"}
                        ...
                        <View style={{ flexDirection: 'column', flex: 1.2, marginTop: "5%", }}>
                            ...
                            {/* <View style={{ marginStart: "25%", flexDirection: 'row' }}> */}
                            <View pointerEvents="none" >
                                <CheckBox checked={Global_Attributes.PonOneBean['nsc']}
                                    // style={{ marginStart: 30, marginTop: 20 }}
                                    unCheckedBorderColor={'#7B7B7B'}
                                    checkedBackgroundColor={"#7B7B7B"}
                                    checkedBorderColor={"#7B7B7B"}
                        ...
                        <View style={{ flexDirection: 'column', flex: 1.2, marginTop: "5%", }}>
                            ...
                            <View pointerEvents="none" style={{}}>
                                <CheckBox checked={Global_Attributes.PonOneBean['commercial']}
                                    // style={{ marginStart: 30, marginTop: 20 }}
                                    unCheckedBorderColor={'#7B7B7B'}
                                    checkedBackgroundColor={"#7B7B7B"}
                                    checkedBorderColor={"#7B7B7B"}
                    ...
                    {Global_Attributes.PonOneBean['cvor'] || Global_Attributes.PonOneBean['nsc'] ?
                        <View style={previewStyle.inputTextcodeView}>
                            <TextInput style={previewStyle.inputTextStyle}
                                label='CVOR/NSC Number*' underlineColor={'#7B7B7B'}
                                editable={false}
                                value={Global_Attributes.PonOneBean['covrNumer']}
                            ></TextInput>
                        </View> : null}
                    ...
                    <View style={previewStyle.fineBoxView}>
                        <View style={previewStyle.insidefineBoxView}>
                            ...
                            <TextInput
                                editable={false}
                                mode='outlined' outlineColor='#11246F' selectionColor={"#7B7B7B"}
                    ...
                    <View style={previewStyle.btnView1}>
                        <View style={previewStyle.insideBtnView1}>
                            <TouchableOpacity style={previewStyle.warBtn}
                                onPress={() => { this.generatePon(Global_Attributes.warningtick, "warning") }}>
                                <Text style={previewStyle.warBtntxt}>GENERATE WARNINGS</Text>
                            </TouchableOpacity>
                        </View>

                        <View style={previewStyle.insideBtnView1}>
                            <TouchableOpacity style={previewStyle.tckBtn}
                                onPress={() => { this.generatePon(Global_Attributes.submitPon, "PonInfo") }}>
                                <Text style={previewStyle.warBtntxt}
