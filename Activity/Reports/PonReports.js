...
// import { View, Text ,TextInput, TouchableOpacity,SafeAreaView,FlatList,Image,StyleSheet,Modal,Alert,Button, PermissionsAndroid,Linking } from 'react-native';
...
//           Alert.alert("Permissions Required ", "Required permisssion(s) have been set not to ask agian! Please provide them from settings", 
//         [{ text: 'Cancel', }, { text: 'SETTING',onPress:() =>this.OpenSetting()}]);
//         await AsyncStorage.setItem('status','');
//         return true; 
//         }
//         else if(result === RESULTS.UNAVAILABLE){
//           Alert.alert("Alert ! ", "This feature is not supported to this Smartphone");
//           return true; 
//         }
//         else {
...
//             Alert.alert("Permissions Required ", "Audio permission is required to use this feature !", 
//             [{ text: 'Cancel', }, { text: 'Ok',onPress:()=>this.setState({status:'blocked'})}])
//          await AsyncStorage.setItem('status','');
//          return true
//           } 
...
//         this.setState({Alert_Visibility: visible,pon_id:pon_id,ticket_no:ticket_no});
//       }
...
//           const abc = await new ReportsController().uploadNotes(addnotes,this.props,"PonReports",Global_Attributes.RSUploadNotes);
//           abc;
...
//           this.setState({Alert_Visibility:false,placeholder:'Tap to Speak',colorId:0,status:''})
...
//       const abc = await new ReportsController().getTicketDetails(ticketBody,this.props,"PonReports",Global_Attributes.RSGetTicketDetails);
...
//             Global_Attributes.Name=(ticketObj['fname'+i+'lname'+i +'mname'+i]);
...
//                 <View style={{flexDirection:'row',marginTop:5,marginStart:10,marginEnd:10}}>
//                 <Text style={{fontSize:17,fontWeight:'bold',flex:1,color:'black'}}>{ Global_Attributes.TicketId} </Text>
//                 <Text style={{fontSize:17,fontWeight:'bold',flex:1,textAlign:'right',color:'black'}}>{ Global_Attributes.Date}</Text>
//                 </View>       
            
              
//             <View style={{flexDirection:'row',marginTop:16,marginStart:10,marginEnd:10}}>

//                      <Text style={{fontSize:17,flex:1,color:'black'}}>{Global_Attributes.Name}</Text>
//                      <TouchableOpacity onPress={() => { this.Show_Custom_Alert(true,ticketObj['pon_id'+i],ticketObj['ticket_no'+i]) }}
//                             style={{alignSelf:'flex-end'}}>
//                             <Image source={Ticketsuser} style={{width:25,height:25,tintColor:'#d50b16',alignSelf:'flex-end'}}/>
//                     </TouchableOpacity>    
//             </View>
//             <View style={{flexDirection:'row',alignSelf:'center'}}>
//             <TouchableOpacity
//             onPress={()=>{this.props.navigation.navigate('Print',{url:ticketObj['offender_copy'+i],module:"Reports"})
//             }}
//             style={TicketsComponentStyle.offender_officer_court_button}>
//                 <Text style={TicketsComponentStyle.offender_officer_court_button_text}>OFFENDER</Text>
//             </TouchableOpacity>
//             <TouchableOpacity
//              onPress={()=>{this.props.navigation.navigate('Print',{url:ticketObj['OfficerPonPdf'+i],module:"Reports"})
//             }}
//             style={TicketsComponentStyle.offender_officer_court_button}>
//                 <Text style={TicketsComponentStyle.offender_officer_court_button_text}>OFFICER</Text>
//             </TouchableOpacity>
//             <TouchableOpacity
//              onPress={()=>{this.props.navigation.navigate('Print',{url:ticketObj['CourtPonPdf'+i],module:"Reports"})
//             }}
//             style={TicketsComponentStyle.offender_officer_court_button}>
//                 <Text style={TicketsComponentStyle.offender_officer_court_button_text}>COURT</Text>
//             </TouchableOpacity>
//             </View>
//                {(ticketObj['hold_status'+i]) == "Y"? 
//                <TouchableOpacity
//                   style={TicketsComponentStyle.cancel_roadside_button}
//                   onPress={()=>{this.Show_Cancel_Roadeside_Alert(true,ticketObj['ticket_no'+i])}}
//                 > 
//                 <Text style={TicketsComponentStyle.cancel_roadside_button_text}>CANCEL ROADSIDE</Text>
//               </TouchableOpacity>
//               :null
//               }

//             {/* Horizantal Line */}
//             <View style={{backgroundColor:'#13226b', height:1,marginRight:25,marginLeft:25,marginBottom:10,marginTop:10}}/> 
//             </View>
//         );
...
//         <TextInput placeholder='Search Tickets' style = {TicketsStyle.textinput}
//          onChangeText={(text)=> this.setState({searchVal:text})} ></TextInput>
            
           
//             <TouchableOpacity style={TicketsStyle.search_button}
//                onPress ={() =>{this.Search_btn()}}>
...
//             } 
//             <View style={{flex:1,}}>
//             <Text style={Ticket_Index != '1 of 1'? styles.text_Pages : styles.text_Page }>{Ticket_Index}</Text>
//             </View>
//            {Next_Index != '' ?
...
//                                 activeOpacity={0.7}>
//                                 <Text style={TicketsComponentStyle.submit_cancel_text}> SUBMIT </Text>
//                             </TouchableOpacity>
//                             <TouchableOpacity
//                                 style={TicketsComponentStyle.cancel_button}
//                                 onPress={this.oncancel_notes_Btn}
//                                 activeOpacity={0.7}>
//                                 <Text style={TicketsComponentStyle.submit_cancel_text}> CANCEL </Text>
//                             </TouchableOpacity>
//                         </View>
//                     </View>
//                 </View>
...
//                       transparent={true}
//                       animationType={"fade"}
//                       onRequestClose={ () => { this.Show_Cancel_Roadeside_Alert(!this.state.Cancel_Roadside)} } 
//                     >
...
//                         <View style={TicketsComponentStyle.cancel_roadside_modal_bottom_container}>
//                             <TouchableOpacity
//                                 style={TicketsComponentStyle.submit_button}
